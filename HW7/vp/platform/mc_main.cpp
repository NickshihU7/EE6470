...
#include "memory.h"
#include "syscall.h"
#include "GaussianBlur0.h"
#include "GaussianBlur1.h"
...
public:
	...
	addr_t GaussianBlur0_start_addr = 0x30000000;
	addr_t GaussianBlur0_size = 0x01000000;
	addr_t GaussianBlur0_end_addr = GaussianBlur0_start_addr + GaussianBlur0_size - 1;
	addr_t GaussianBlur1_start_addr = 0x31000000;
	addr_t GaussianBlur1_size = 0x01000000;
	addr_t GaussianBlur1_end_addr = GaussianBlur1_start_addr + GaussianBlur1_size - 1;
	addr_t dma_start_addr = 0x40000000;
	addr_t dma_end_addr = 0x40001000;
	addr_t plic_start_addr = 0x50000000;
	addr_t plic_end_addr = 0x51000000;
...
int sc_main(int argc, char **argv) {
	...
	GaussianBlur0 gaussian_blur0("gaussian_blur0");
	GaussianBlur1 gaussian_blur1("gaussian_blur1");
	...
	bus.ports[4] = new PortMapping(opt.GaussianBlur0_start_addr, opt.GaussianBlur0_end_addr);
	bus.ports[5] = new PortMapping(opt.GaussianBlur1_start_addr, opt.GaussianBlur1_end_addr);
