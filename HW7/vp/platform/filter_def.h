...
const int SOBEL_FILTER_RESULT_ADDR1 = 0x00000004;
const int SOBEL_FILTER_RESULT_ADDR2 = 0x00000008;
const int SOBEL_FILTER_RESULT_ADDR3 = 0x0000000c;
...
// Gaussian mask
const double mask1[MASK_X][MASK_Y] = 
