...
public:
	...
	addr_t GaussianBlur_start_addr = 0x74000000;
	addr_t GaussianBlur_size = 0x01000000;
	addr_t GaussianBlur_end_addr = GaussianBlur_start_addr + GaussianBlur_size - 1;
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[12] = new PortMapping(opt.GaussianBlur_start_addr, opt.GaussianBlur_end_addr);
